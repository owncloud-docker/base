...
- `OWNCLOUD_OVERWRITE_PROTOCOL=` \
  Override protocol (http/[documentation](https) usage (see [documentation](<https://doc.owncloud.com/server/latest/admin_manual/configuration/server/config_sample_php_parameters.html#override-protocol-http[documentation](https-usage)>)
