...
- `OWNCLOUD_ACCOUNTS_ENABLE_MEDIAL_SEARCH=` Allow medial search on user account properties ([Details](https://doc.owncloud.com/server/next/admin_manual/configuration/server/config_sample_php_parameters.html#allow-medial-search-on-user-account-properties))
