...
declare -x OWNCLOUD_WND_ACTIVITY_REGISTER_EXTENSION
[[ -z "${OWNCLOUD_WND_ACTIVITY_REGISTER_EXTENSION}" ]] && OWNCLOUD_WND_ACTIVITY_REGISTER_EXTENSION=""

declare -x OWNCLOUD_WND_ACTIVITY_SEND_TO_SHAREES
[[ -z "${OWNCLOUD_WND_ACTIVITY_SEND_TO_SHAREES}" ]] && OWNCLOUD_WND_ACTIVITY_SEND_TO_SHAREES=""

declare -x OWNCLOUD_WND_CONNECTOR_OPTS_TIMEOUT
...
[[ -z "${OWNCLOUD_WND_ERROR_CODES_PASSWORD_RESET}" ]] && OWNCLOUD_WND_ERROR_CODES_PASSWORD_RESET=""

declare -x OWNCLOUD_WND_FILE_INFO_PARSE_ATTRS_MODE
[[ -z "${OWNCLOUD_WND_FILE_INFO_PARSE_ATTRS_MODE}" ]] && OWNCLOUD_WND_FILE_INFO_PARSE_ATTRS_MODE=""

declare -x OWNCLOUD_WND_GROUP_MEMBERSHIP_CHECK_USER_FIRST
[[ -z "${OWNCLOUD_WND_GROUP_MEMBERSHIP_CHECK_USER_FIRST}" ]] && OWNCLOUD_WND_GROUP_MEMBERSHIP_CHECK_USER_FIRST=""

declare -x OWNCLOUD_WND_IN_MEMORY_NOTIFIER_ENABLE
[[ -z "${OWNCLOUD_WND_IN_MEMORY_NOTIFIER_ENABLE}" ]] && OWNCLOUD_WND_IN_MEMORY_NOTIFIER_ENABLE=""

declare -x OWNCLOUD_WND_LISTEN_EVENTS_SMB_ACL
[[ -z "${OWNCLOUD_WND_LISTEN_EVENTS_SMB_ACL}" ]] && OWNCLOUD_WND_LISTEN_EVENTS_SMB_ACL=""

declare -x OWNCLOUD_WND_LISTEN_RECONNECT_AFTER_TIME
[[ -z "${OWNCLOUD_WND_LISTEN_RECONNECT_AFTER_TIME}" ]] && OWNCLOUD_WND_LISTEN_RECONNECT_AFTER_TIME=""

declare -x OWNCLOUD_WND_LOGGING_ENABLE
[[ -z "${OWNCLOUD_WND_LOGGING_ENABLE}" ]] && OWNCLOUD_WND_LOGGING_ENABLE=""

declare -x OWNCLOUD_WND_PERMISSION_MANAGER_CACHE_SIZE
[[ -z "${OWNCLOUD_WND_PERMISSION_MANAGER_CACHE_SIZE}" ]] && OWNCLOUD_WND_PERMISSION_MANAGER_CACHE_SIZE=""

declare -x OWNCLOUD_WND2_CACHE_WRAPPER_NORMALIZE
[[ -z "${OWNCLOUD_WND2_CACHE_WRAPPER_NORMALIZE}" ]] && OWNCLOUD_WND2_CACHE_WRAPPER_NORMALIZE=""

declare -x OWNCLOUD_WND2_CACHE_WRAPPER_TTL
[[ -z "${OWNCLOUD_WND2_CACHE_WRAPPER_TTL}" ]] && OWNCLOUD_WND2_CACHE_WRAPPER_TTL=""
