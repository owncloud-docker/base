...
[[ -z "${OWNCLOUD_TRUSTED_DOMAINS}" ]] && PURE_OWNCLOUD_DOMAIN="${OWNCLOUD_DOMAIN%:*}" && OWNCLOUD_TRUSTED_DOMAINS="${PURE_OWNCLOUD_DOMAIN:-localhost}"
...
declare -x OWNCLOUD_CROND_SCHEDULE
[[ -z "${OWNCLOUD_CROND_SCHEDULE}" ]] && OWNCLOUD_CROND_SCHEDULE="*/1 * * * *"
